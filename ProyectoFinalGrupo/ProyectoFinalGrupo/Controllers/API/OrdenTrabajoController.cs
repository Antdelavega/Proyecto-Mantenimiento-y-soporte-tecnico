...
namespace ProyectoFinalGrupo.Controllers.API
{
    ...
    public class OrdenTrabajoController : ControllerBase
    {
        ...
        public OrdenTrabajoController(ProyectoFinalGrupoContext context)
        {
            _context = context;
        }
        ...
        public IEnumerable<OrdenTrabajo> GetOrdenT()
        {
        ...
        public ActionResult Index()
        {
            ...
            {
                var list = (from u in db.OrdenTrabajo
                            join t in db.Departamentos
                            on u.DepartamentosId equals t.Id
                            select new
                            {
                                id = u.Id,
                                departamentoid = u.DepartamentosId,
                                idpto = t.Id,
                                nombredpto = t.Nombre,
                                detalledpto = t.Detalles
